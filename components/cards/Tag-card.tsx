...
const TagCard = ({
  ...
  if (compact) {
    return isButton ? (
      ...
      <Link
        href={siteConfig.ROUTES.TAG(_id)}
  ...
  return (
    ...
    >
      <article className="background-light900_dark200 light-border flex h-full w-full max-w-[200px] flex-col rounded-2xl border p-8">
