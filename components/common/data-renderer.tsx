...
const StateSkeleton = ({
  ...
  <div className="mt-16 flex w-full flex-col items-center justify-center sm:mt-20">
    ...
    <p className="body-regular text-dark500_light400 my-3.5 max-w-md text-center">
      {message}
    </p>
    {button && (
      <Link href={button.href}>
        <Button className="paragraph-medium bg-primary-500 text-light-900 hover:bg-primary-500 mt-5 min-h-11 rounded-lg px-4 py-3">
          {button.text}
        </Button>
      </Link>
    )}
